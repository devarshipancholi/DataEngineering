...
*Program 1.1: Program to Read Temperatures in Degrees Celsius and Convert them to Fahrenheit;
**Program C_to_F
 Program to read temperatures in degrees Celsius and convert
 them to degrees Fahrenheit;
Data Convert;
   infile "/home/carlosdeoliveira0/my_content/celsius.txt"; 
   input Temp_C;
...
*Program 1.2: Reading Text Data from an Exernal File;
data Demo;
   infile "/home/carlosdeoliveira0/my_content/demographic.txt";
   input ID $ Gender $ Age Height Weight Party $;
run;

*Program 1.3: Computing frequencies on the Demo Data Set;
data Demo;
   infile "/home/carlosdeoliveira0/my_content/demographic.txt";
   input ID $ Gender $ Age Height Weight Party $;
run;
...
*Program 2-1: Reading Data with Delimiters (Blanks);
/* This is another way to insert a coment */
data Blanks /* the data set name is Blanks */;
   infile "/home/carlosdeoliveira0/my_content/Blank_Delimiter.txt" missover;
...
*-Program 2.2: Reading CSV Files;
data commas;
   infile "/home/carlosdeoliveira0/my_content/Comma_Delimiter.txt" dsd missover;
   informat ID $11. First Last $15. Gender $1. State_Code $2.;
   input ID First Last Gender Age State_Code;
run;
...
*Program 2-3: Reading Tab Delimited Data;
data tabs;
   infile "/home/carlosdeoliveira0/my_content/Tab_Delimiter.txt" dlm='09'x missover;
   informat ID $11. First Last $15. Gender $1. State_Code $2.;
   input ID First Last Gender Age State_Code;
run;
...
*Program 2-4: Reading Data in Fixed Columns Using Column Input;
data Health;
   infile '/home/carlosdeoliveira0/my_content/health.txt' pad;
   input Subj   $ 1-3
         Gender $ 4
         Age      5-6
         HR       7-8
...
*Program 2-5: Reading Data in Fixed Columns Using Formatted Input;
data health;
   infile '/home/carlosdeoliveira0/my_content/health.txt' pad;
   input @1  Subj   $3.
         @4  Gender $1.
...
*Program 2-6: Demonstrating Formatted Input;
data health;
   infile '/home/carlosdeoliveira0/my_content/health.txt' pad;
   input @1  Subj   $3.
         @4  Gender $1.
...
*Program 2-7: File Snippet to Import the Grades.xlsx Workbook;
PROC IMPORT DATAFILE="/home/carlosdeoliveira0/my_content/Grades.xlsx" 
                 OUT=A.GRADES
          DBMS=XLSX
          REPLACE;
RUN;
/** Print the results. **/
PROC PRINT DATA=A.Grades; 
RUN;

*Program 2-8: Code to Import the Grades2 Workbook;
/** Import an XLS file.  **/

PROC IMPORT DATAFILE="/home/carlosdeoliveira0/my_content/Grades2.xlsx"
          OUT=WORK.Grades2
          DBMS=XLSX
          REPLACE;
RUN;
/** Print the results. **/
PROC PRINT DATA=WORK.Grades2; 
RUN;


*Program 3-1: Running PROC CONTENTS to Examine the Data Descriptor for Data Set DEMO;
...
*Program 3-2: Reading the HeightWeight.txt File Located in /home/carlosdeoliveira0/my_content/;
data HtWt;
   infile '/home/carlosdeoliveira0/my_content/HeightWeight.txt';
   input Height Weight;
run;

*Program 3-3: Program to Create a Permanent SAS Data Set;
*Program to create a permanent SAS data set called Demo in the
 /home/carlosdeoliveira0/my_content/ folder;
libname mydata '/home/carlosdeoliveira0/my_content/';
data mydata.Demo;
   infile "/home/carlosdeoliveira0/my_content/demographic.txt/";
   input ID $ Gender $ Age Height Weight Party $;
run;

*Program 3-4: Using a SAS Data Set as Input to a Program;
libname mydata '/home/carlosdeoliveira0/my_content/';
data mydata.New_Demo;
   set mydata.Demo;
   Wt_Kg = Weight / 2.2;
run;
...
*Program 4-1: Creating the Taxes Data Set (and Demonstrating a DATALINES Statement);
data Taxes;
   informat SSN $11.
            Gender $1.
...
*Program 4-2: Creating Your Own Formats;
proc format;
   value $Gender 'M'='Male' 
                 'F'='Female';
   value $Yesno '0'='No' 
...
*Program 4-3: Computing Frequencies on the Taxes Data Set (without Formats);
title 'Frequencies for the Taxes Data Set';
proc freq data=Taxes;
   tables Gender Question_1 - Question_5 / nocum;
run;

*Program 4-4: Adding a Format Statement to PROC FREQ;
title 'Frequencies for the Taxes Data Set';
proc freq data=Taxes;
...
*Program 4-5: Making a Permanent Formnat;
libname myfmts '/home/carlosdeoliveira0/my_content';
...
*Program 4-6: Adding the FMTLIB Option;
...
*Program 4-7: Creating Variable Labels;
data Taxes;
   informat SSN $11.
            Gender $1.
            Question_1 - Question_4 $1.;
...
*Program 5-2: Corrected Version of Program 1;
data People;
   input @1  ID     $3. 
         @4  Gender $1.
         @5   Age    3.
...
*Program 5-3: Using Conditional Logic to Test for Out-of-Range Data Values;
data _null_;
   set People;
...
*Program 5-4: A Common Error Using Multiple OR Operators;
data Mystery;
   input x;
...
-5
;
title "Listing of Data Set MYDERY";
proc print data=Mystery noobs;
run;

*Program 5-5: A Corrected Version of Program 4;
data Mystery;
   input x;
...
*Program 6-1: Creating a Table of Celsius and Fahrenheit Temperatures;
data Convert_Temp;
   do Temp_C = -50 to 50;
      Temp_F = 1.8*Temp_C + 32;
      output;
...
*Program 6-2: Graphing a Cubic Equation;
data Cubic;
   do x = -5 to 5 by .01;
      y = 2*x**3 - x**2 + 3*x;
      output;
...
*Program 6-3: Using a DO with Character Values;
data HR_Study;
   do Drug_Group = 'Placebo','Drug A','Drug C';
      input Heart_Rate @;
      output;
   end;
datalines;
...
*Program 6-4: Demonstrating a DO WHILE Loop;
data Bank;
   Interest_Rate=.07;
   Amount = 1000;
   Goal = 2000;
...
*Program 6-5: Combining an Iterative DO Loop with a WHILE Condition;
data Bank;
   Interest_Rate=.07;
   Amount = 1000;
   Goal = 2000;
...
*Program 6-6: Demonstrating a DO UNTIL Loop;
data Bank;
   Interest_Rate=.07;
   Amount = 1000;
   Goal = 2000;
...
*Program 6-7: Demonstrating that a DO UNTIL Loop Will Always Execute Once;
data At_Least_Once;
   x = 5;
   do until (x = 5);
...
*Program 6-8: Combining an Iterative DO Loop with an UNTIL Condition;
data Bank;
   Interest_Rate=.07;
   Amount = 1000;
   Goal = 2000;
...
*Program 6-9: Demonstrating s LEAVE Statement;
data Bank;
   Interest_Rate=.07;
   Amount = 1000;
   Goal = 2000;
...
*Program 6-10: Demonstrating a CONTINUE Statement;
data Bank;
   Interest_Rate=.07;
   Amount = 1000;
   Goal = 2000;
...
*Program 7-1: Reading Dates in a Variety of Date Formats;
data Read_Dates;
   infile '/folders/myfolders/Date_Data.txt' pad;
...
*Program 7-2: Adding Formats to Display the Date Values;
data Read_Dates;
   infile '/folders/myfolders/Date_Data.txt' pad;
   input @1  Date1 mmddyy10.
         @12 Date2 date9.
...
*Program 7-3: Demonstrating a Date Constant;
data _null_;
title "Checking for Out of Range Dates";
   input @1 Date mmddyy10.;
   file print;
   if Date lt '01Jan2012'd and not missing(Date) or
      Date gt '31Dec2014'd then put "Date " Date "is out of range";
...
*Program 7-4: Extracting the Day of the Week, Day of the Month, and Year from a SAS Date;
data Extract;
...
*Program 7-5: Creating a Variable Representing Day of the Week Abbreviations;
proc format;
...
*Program 8-1: Using a WHERE Statement to Subset a SAS Data Set;
data Year1980;
   set sashelp.retail;
   where Year = 1980;
run;
...
*Program 8-2: Demonstrating a More Complicated Query;
data Complicated;
   set sashelp.retail;
...
*Program 8-3: Rewriting Program 1 Using a WHERE= Data Set Option;
data Year1980;
   set sashelp.retail (where=(Year = 1980));
run;

*Program 8-4: Using a WHERE Data Set Option in a SAS Procedure;
proc print data=sashelp.Retail (where=(Year = 1980));
run;

*Program 8-5: Demonstrating the Subsetting IF Statement;
data Females;
   input @1  ID     $3. 
         @4  Gender $1.
         @5   Age    3.
...
*Program 8-6: Demonstrating a Trailing @;
data Females;
   input @4  Gender $1. @;
   if Gender = 'F' then 
      input @5   Age    3.
...
*Program 8-7: Creating Several SAS Data Sets in One DATA step;
...
/*** Note: Program 8-9 must be run before Program 8-8
     so the order was changed in this file ***/
     
*Program 8-9: Program to Create Data Sets ONE and TWO;
data One;
...
*Program 8-8: Using a SET Statement to Combine Two SAS Data Sets;
data Both;
   set One Two;
run;


/*** Programs 8-10 to 8-12 for demonstration purposes, not meant to be run
*Program 8-10: Using a SET Statement to Solve the Problem;
Data Both;
   Set Big Small;
run;
*Program 8-11: Using PROC APPEND to Add Observations from One Data Set to another;
proc append base=Big Data=Small;
run;

*Program 8-12: Demonstrated How to Interleave Two or More Data Sets;
data combined;
...
*Program 8-13: Creating the Patients and Visits Data Sets;
data Patients;
...
*Program 8-14: Merging Two SAS Data Sets;
...
*Program 8-16: Using the IN= Data Set Options to Control the Merge Operation;
...
*Program 8-17: Creating Another Data Set to Demonstrate a One-to-Many Merge;
data Many_Visits;
   informat ID $4. Visit_Date mmddyy10.;
...
*Program 8-18: Performing a One-to-Many Merge;
proc sort data=Patients;
   by ID;
run;
...
*Program 8-19: Program to Create Data Set Visits_2;
data Visits_2;
...
*Program 8-20: Using a RENAME= Data Set Option to Rename the Variable Pt to ID;
proc sort data=Patients;
   by ID;
run;
...
*Program 8-21: Program to Create Data Sets One_Char and Two_Num;
data One_Char;
...
*Program 8-22: Merging Two Data Sets with One Character and One Numeric BY Variable;
data Two_Char;
...
*Program 8-23: Program to Create the Master File;
data Price;
...
*Program 8-24: Creating the Transaction Data Set;
data Transact;
...
*Program 8-25: Updating Your Master File Using a Transaction Data Set;
...
data Big_New;
   ...
   do i = 1 to dim{all_chars);
      all_chars[i] = upcase(all_chars[i]_;
   end;
   drop i;
run;
